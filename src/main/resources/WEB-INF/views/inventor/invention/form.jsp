...
<acme:form> 
	Regla de negocio: Si no es un borrador y no es una creaci�n, se bloquea la edici�n
	<jstl:choose>
	...
	<jstl:choose>
		...
		Se incluye 'publish' en la disyunci�n para evitar el bloqueo si la validaci�n falla
...
<acme:form> 
	<jstl:choose>
		...
		<jstl:otherwise>
			...
			<%-- Inyecci�n de propiedades derivadas (Bloqueadas incluso en modo edici�n) --%>
			<acme:form-textbox code="inventor.invention.form.label.cost" path="cost" readonly="true"/>
			<acme:form-textbox code="inventor.invention.form.label.monthsActive" path="monthsActive" readonly="true"/>
