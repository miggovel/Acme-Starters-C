...
<acme:form>
	...
	<acme:form-double code="any.campaign.form.label.get-months-active" path="getMonthsActive" readonly="true"/>
	<acme:form-double code="any.campaign.form.label.get-effort" path="getEffort" readonly="true"/>
