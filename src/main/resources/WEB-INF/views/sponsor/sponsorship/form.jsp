...
<acme:form>
    ...
    <acme:form-moment code="sponsor.sponsorship.form.label.start-moment" path="startMoment"/>
    <acme:form-moment code="sponsor.sponsorship.form.label.end-moment" path="endMoment"/>
    <acme:form-url code="sponsor.sponsorship.form.label.more-info" path="moreInfo"/>
    ...
    <acme:form-double code="sponsor.sponsorship.form.label.total-money" path="totalMoney.amount" readonly="true"/>

    <!-- Botones según comando y draftMode -->
    <jstl:choose>
        <jstl:when test="${_command == 'show' && draftMode == false}">
        	<acme:button code="sponsor.sponsorhip.form.button.donations" action="/sponsor/donation/list?sponsorshipId=${id}"/>
            <acme:button code="sponsor.sponsorship.form.button.sponsor-profile" action="/any/sponsor/show?id=${sponsorId}"/>
        </jstl:when>
