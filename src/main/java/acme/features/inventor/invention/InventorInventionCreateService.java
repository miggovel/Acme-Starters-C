...
public class InventorInventionCreateService extends AbstractService<Inventor, Invention> {
	...
	@Autowired
	private InventorInventionRepository	InventorInventionR;
	...
	public void validate() {
		...
		Invention existing = this.InventorInventionR.findOneByTicker(this.invention.getTicker());
	...
	@Override
	public void execute() {
		this.InventorInventionR.save(this.invention);
